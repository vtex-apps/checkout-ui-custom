module.exports._locale = {
  ...
  ITL: {
    ...
    locale: 'it-IT',
    goToShipping: 'Vai alla spedizione',
    couponInactive: 'Nessuno sconto disponibile. Verifica le condizioni',
    identifiedUserMessage: `Grazie per essere tornato!\nPer velocizzare la tua transazione, abbiamo compilato in modo sicuro le tue informazioni per te`,
    googleAddressLabel: 'Indirizzo',
    noStreetAddress: 'Nelle tue informazioni di spedizione manca un campo obbligatorio, includi una via o un P.O. Scatola',
  },
  PLD: {
    couponInactive: 'Brak dostępnych upustów. Sprawdź warunki.',
    editLabel: 'Edytuj',
    ...
    noStreetAddress: 'W Twoich informacjach o wysyłce brakuje wymaganego pola. Podaj ulicę lub numer punktu dostawy. Skrzynka',
  },
  RSN: {
    couponInactive: 'Скидки недоступны. Проверьте условия.',
    editLabel: 'Редактировать',
    ...
    noStreetAddress: 'В информации о доставке отсутствует обязательное поле, укажите улицу или почтовый адрес. Коробка',
  },
  FRN: {
    couponInactive: 'Aucune réduction disponible. Vérifiez les conditions.',
    editLabel: 'Modifier',
    ...
    locale: 'fr-FR',
    country: 'Pays',
    identifiedUserMessage: `Merci d'être revenu !\nPour accélérer votre transaction, nous avons rempli vos informations en toute sécurité pour vous`,
    googleAddressLabel: 'Adresse de la rue',
    noStreetAddress: "Il manque un champ obligatoire à vos informations d'expédition, veuillez inclure une rue ou un P.O. Boîte",
  },
  ESN: {
    couponInactive: 'No hay descuentos disponibles. Consulta las condiciones.',
    editLabel: 'Editar',
    ...
    locale: 'es-ES',
    country: 'País',
    identifiedUserMessage: `¡Gracias por regresar!\nPara agilizar su transacción, hemos completado su información de forma segura por usted`,
    googleAddressLabel: 'Este campo es obligatorio',
    noStreetAddress: 'A su información de envío le falta un campo obligatorio, incluya una calle o P.O. Caja',
  },
  PTG: {
    couponInactive: 'No hay descuentos disponibles. Consulta las condiciones.',
    editLabel: 'Editar',
    ...
    locale: 'es-ES',
    country: 'País',
    identifiedUserMessage: `Obrigado por voltar!\nPara agilizar sua transação, preenchemos suas informações com segurança para você`,
    googleAddressLabel: 'Endereço da Rua',
    noStreetAddress: 'Falta um campo obrigatório em suas informações de remessa. Inclua uma rua ou endereço postal. Caixa',
  },
  JPN: {
    country: '国',
    postalCode: '郵便番号',
    couponInactive: '割引はありません。条件を確認する',
    editLabel: '編集',
    paypalImg: '',
    paypalPhone: '',
    cartSubmitButton: '支払いに進む',
    deliveryDateText: 'までに到着',
    PickupDateText: 'までに準備完了',
    eachLabel: 'それぞれ',
    tomorrowLabel: '明日',
    cartNoteLabel: 'ギフトメッセージまたはコメント',
    identifiedUserMessage: `戻ってきてくれてありがとう!\n取引を迅速に進めるために、お客様の情報を安全に入力しました。`,
    address1Placeholder: '住所または私書箱箱',
    address2Placeholder: 'アパート、スイート、ビル、フロアなど (オプション)',
    checkoutStepsLabelCart: 'カート',
    checkoutStepsLabelIdentification: '識別',
    checkoutStepsLabelShipping: '配送',
    checkoutStepsLabelPayment: '支払い',
    checkoutStepsLabelConfirmation: '確認',
    googleAddressLabel: '住所',
    requiredField: 'この項目は必須です',
    city: '市',
    state: '州',
    locale: 'jp-JP',
    noStreetAddress: '配送情報に必須フィールドがありません。番地または私書箱を入力してください。箱',
  },
  KOR: {
    country: '국가',
    postalCode: '우편 번호',
    couponInactive: '할인이 없습니다. 조건 확인',
    editLabel: '편집하다',
    paypalImg: '',
    paypalPhone: '',
    cartSubmitButton: '결제 진행',
    deliveryDateText: '도착시간',
    PickupDateText: '준비자',
    eachLabel: '각',
    tomorrowLabel: '내일',
    cartNoteLabel: '선물 메시지 또는 의견',
    identifiedUserMessage: `다시 방문해 주셔서 감사합니다!\n거래를 신속히 처리하기 위해 귀하의 정보를 안전하게 입력했습니다.`,
    address1Placeholder: '거리 주소 또는 P.O. 상자',
    address2Placeholder: '아파트, 스위트, 건물, 층 등(선택사항)',
    checkoutStepsLabelCart: '카트',
    checkoutStepsLabelIdentification: '신분증',
    checkoutStepsLabelShipping: '배송',
    checkoutStepsLabelPayment: '지불',
    ...
    state: '상태',
    locale: 'ko-KR',
    noStreetAddress: '배송 정보에 필수 입력란이 누락되었습니다. 거리 또는 P.O를 포함하세요. 상자',
  },
  CHN: {
    country: '国家',
    postalCode: '邮政编码',
    couponInactive: '没有折扣。检查条件',
    editLabel: '编辑',
    paypalImg: '',
    paypalPhone: '',
    cartSubmitButton: '继续付款',
    deliveryDateText: '到达时间',
    PickupDateText: '准备就绪',
    eachLabel: '每个',
    tomorrowLabel: '明天',
    cartNoteLabel: '礼物留言或评论',
    identifiedUserMessage: `感谢您回来！\n为了加快您的交易，我们已安全地为您填充您的信息`,
    address1Placeholder: '街道地址或邮政信箱盒子',
    address2Placeholder: '公寓、套房、大楼、楼层等（可选',
    checkoutStepsLabelCart: '大车',
    checkoutStepsLabelIdentification: '鉴别',
    checkoutStepsLabelShipping: '船运',
    checkoutStepsLabelPayment: '支付',
    checkoutStepsLabelConfirmation: '确认',
    googleAddressLabel: '街道地址',
    requiredField: '此字段是必需的',
    city: '城市',
    state: '状态',
    locale: 'zh-CN',
    noStreetAddress: '您的送货信息缺少必填字段，请包含街道或邮政信箱。盒子',
  },
  TWN: {
    country: '国家',
    postalCode: '邮政编码',
